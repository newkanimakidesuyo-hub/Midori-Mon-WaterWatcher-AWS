...
import { MOISTURE_TABLE_NAME, TEMPERATURE_TABLE_NAME, THING_NAMES } from '../shared/water-watcher-constants';
...
const GRAPH_LAMBDAS: LambdaWithLogGroupConfig[] = [
  {
    ...
    description: 'Grafana SimpleJSON datasource API backed by DynamoDB (moisture / temperature_c)',
